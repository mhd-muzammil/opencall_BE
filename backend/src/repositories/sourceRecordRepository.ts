...
export async function findFlexWipRecordsByBatchId(
  ...
  return result.rows.map((row) => ({
    ...
    goodPartNo: cleanString(getCell(row.raw_row as Record<string, unknown>, ["Good Part No", "Good Part Number"])),
    partOrderNo: cleanString(getCell(row.raw_row as Record<string, unknown>, ["Part Order No", "Part Order Number"])),
    soNumber: cleanString(getCell(row.raw_row as Record<string, unknown>, ["SO Number", "So Number"])),
    goodPartInstalledStatus: cleanString(getCell(row.raw_row as Record<string, unknown>, ["Good Part Installed Status"])),
    partShipmentStatus: cleanString(getCell(row.raw_row as Record<string, unknown>, ["Part Shipment Status(EEG)", "Part Shipment Status"])),
    goodPartAwb: cleanString(getCell(row.raw_row as Record<string, unknown>, ["Good Part AWB", "Good Part Awb"])),
    goodPartExpectedDeliveryDate: cleanString(getCell(row.raw_row as Record<string, unknown>, ["Good Part Expected Delivery Date"])),
    goodPartSerialNumber: cleanString(getCell(row.raw_row as Record<string, unknown>, ["Good Part Serial Number", "Good Part Serial No"])),
    rawRow: row.raw_row,
